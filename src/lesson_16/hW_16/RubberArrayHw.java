...
public class RubberArrayHw {
    int[] array; // массив целых чисел, для хранения елементов
    int cursor; // целочисленное поле, указывает на следующую свободную позицию в массиве(также отображает кол-во элементов в массиве)
